...
namespace aspect
{
  namespace Postprocess
  {
    ...
    FluidVelocityStatistics<dim>::execute (TableHandler &statistics)
    {
      ...
      const std::vector<std::string> column_names = {"RMS " + advection_method + " velocity (" + units + ")",
                                                     "Max. " + advection_method + " velocity (" + units + ")"
                                                    };
      ...
      return std::pair<std::string, std::string> ("RMS " + advection_method + ", max " + advection_method + " velocity:",
                                                  output.str());
    }
  }
}
