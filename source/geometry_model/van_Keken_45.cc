...
namespace aspect
{
  namespace GeometryModel
  {
    ...
    template <int dim>
    Point<dim>
    vanKeken45<dim>::get_extents () const
    {
    ...
    template <int dim>
    Point<dim>
    vanKeken45<dim>::get_origin () const
    {
    ...
    template <int dim>
    double
    vanKeken45<dim>::depth(const Point<dim> &position) const
    {
    ...
    template <int dim>
    double
    vanKeken45<dim>::height_above_reference_surface(const Point<dim> &) const
    {
      return 0.0;
    }
    ...
    template <int dim>
    Point<dim>
    vanKeken45<dim>::representative_point(const double depth) const
    {
      Point<dim> p;
      p(dim-1) = depth;
      return p;
    ...
    template <int dim>
    double
    vanKeken45<dim>::maximal_depth() const
    {
      return 600e3;
    }
    ...
    template <int dim>
    bool
    vanKeken45<dim>::point_is_in_domain(const Point<dim> &) const
    {
      return true;
    }
    ...
    vanKeken45<dim>::natural_coordinate_system() const
    {
    ...
    template <int dim>
    void
    vanKeken45<dim>::declare_parameters (ParameterHandler &)
    {}
    ...
    template <int dim>
    void
    vanKeken45<dim>::parse_parameters (ParameterHandler &)
    {}
  }
}
...
namespace aspect
{
  namespace GeometryModel
  {
    ASPECT_REGISTER_GEOMETRY_MODEL(vanKeken45,
                                   "vanKeken45 box",
