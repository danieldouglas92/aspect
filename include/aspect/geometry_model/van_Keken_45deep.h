...
#ifndef _aspect_geometry_model_vanKeken45deep_h
#define _aspect_geometry_model_vanKeken45deep_h
...
namespace aspect
{
  namespace GeometryModel
  {
    ...
    template <int dim>
    class vanKeken45Deep : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        /**
         * Constructor.
